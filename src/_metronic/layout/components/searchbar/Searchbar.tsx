...
const Searchbar = () => {
  ...
  return (
    ...
    >
      {/* begin::body */}
      <div className='container -fluid container-xxl pt-1 pb-1 p-xxl-0'>
        ...
        <div className='d-flex flex-column'>
          ...
          <div className='d-lg-flex align-lg-items-center'>
            {/* begin::Simple form */}
            <div className='rounded d-flex flex-column flex-lg-row align-items-lg-center bg-body p-5 w-100 h-lg-60px me-lg my-5 border border-secondary'>
              {/* begin::Row */}
              ...
              <div className='min-w-150px text-end'>
                <button type='submit' className='btn btn-outline btn-outline-primary' id='kt_advanced_search_button_1'>
